from linghe.quant.twn import twn_quant_row_fp8, twn_quant_row_fp8_triton, twn_quant_row_tensor_block_fp8_triton
...
def test_twn_quant_fp8(M=2048, N=768, bench=False):
    ...
    x_q, alpha = twn_quant_row_fp8(x)
    x_q_ref, alpha_ref = twn_quant_row_fp8_triton(x)
    __, _ = twn_quant_row_tensor_block_fp8_triton(x)
    ...
    if bench:
        ...
        benchmark_func(twn_quant_row_tensor_block_fp8_triton, x, n_repeat=n_repeat, ref_bytes=M * N * 2)
